package com.swiftcode.config.timezone;

import com.swiftcode.SpaAdminApp;
import com.swiftcode.repository.timezone.DateTimeWrapper;
import com.swiftcode.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = SpaAdminApp.class)
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM spa_date_time_wrapper where id=%d", fieldName, id);
    }
